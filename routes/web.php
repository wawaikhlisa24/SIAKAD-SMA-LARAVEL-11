...
Route::group(['namespace' => 'App\Http\Controllers'],function()
{
    ...
    Route::get('berita/list/page', 'beritaList')->middleware('auth')->name('berita/list/page'); // department/list/page
    Route::get('berita/add/page', 'indexBerita')->middleware('auth')->name('berita/add/page'); // page add department
    Route::get('/edit/{department_id}', 'editBerita'); // page add department
    Route::post('berita/save', 'saveRecord')->middleware('auth')->name('berita/save'); // berita/save
    Route::post('berita/update', 'updateRecord')->middleware('auth')->name('berita/update'); // berita/update
    Route::post('berita/delete', 'deleteRecord')->middleware('auth')->name('berita/delete'); // berita/delete
